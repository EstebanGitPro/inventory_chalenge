...
__all__ = ['login_usuario_admin', 'cargar_csv_completo', 'buscar_equipo', 'leer_todos_equipos', 'buscar_usuario_cedula', 'leer_todas_solicitudes', 'buscar_solicitudes_pendientes', 'leer_todos_prestamos', 'buscar_prestamos_activos', 'buscar_prestamo_equipo']
